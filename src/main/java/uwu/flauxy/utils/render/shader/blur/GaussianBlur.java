package uwu.flauxy.utils.render.shader.blur;

import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.client.renderer.OpenGlHelper;
import net.minecraft.client.shader.Framebuffer;
import org.lwjgl.BufferUtils;
import uwu.flauxy.utils.MathUtils;
import uwu.flauxy.utils.Utils;
import uwu.flauxy.utils.render.RenderUtil;
import uwu.flauxy.utils.render.shader.ShaderUtil;
...
public class GaussianBlur implements Utils {
    ...
    public static ShaderUtil blurShader = new ShaderUtil("Flauxy/Shaders/gaussian.frag");
