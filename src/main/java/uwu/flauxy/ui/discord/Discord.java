...
public class Discord extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)  {
        ...
        FontManager fm = Flauxy.INSTANCE.getFontManager();
        Flauxy.INSTANCE.getFontManager().getFont("Auxy 40").drawString("F" + "lauxy", guiX + 2, guiY + 2
                , new Color(163, 166, 170, 255).getRGB());
        crossX = guiX + width - fm.getFont("Auxy 40").getWidth("X") - 2;

        Flauxy.INSTANCE.getFontManager().getFont("Auxy 40").drawString("X", crossX, guiY + 2
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if(mouseX >= crossX - 2 && mouseX <= crossX + Flauxy.INSTANCE.getFontManager().getFont("Auxy 40").getWidth("X") + 2){
            if(!closed){
                close = true;
