...
public class WaypointManager {
    ...
    public void addWaypoint(Minecraft mc, String wayName) {
        ...
        Flauxy.INSTANCE.waypointManager.waypoints.add(new Waypoint(wayName, (int)mc.thePlayer.posX, (int)mc.thePlayer.posY, (int)mc.thePlayer.posZ, identifier));
    ...
    public void removeWaypoint(String wayName) {
        Iterator<Waypoint> iterator = Flauxy.INSTANCE.waypointManager.waypoints.iterator();
        boolean found = false;
