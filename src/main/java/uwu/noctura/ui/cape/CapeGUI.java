...
import uwu.noctura.cape.Cape;
import uwu.noctura.cape.CapeManager;
import uwu.noctura.module.impl.display.ModuleCapeGUI;
...
public class CapeGUI extends GuiScreen {
    ...
    private final CapeManager capeManager = Noctura.INSTANCE.getCapeManager();
    ...
    public void initGui() {
        ...
        super.initGui();
        ModuleCapeGUI c = Noctura.INSTANCE.getModuleManager().getModule(ModuleCapeGUI.class);
        c.setToggled(false);
        capesYoffset = 0;
    }
