...
public class FlatUi extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)  {
        ...
        Noctura.INSTANCE.getFontManager().getFont("Japan 40").drawString("F" + EnumChatFormatting.WHITE + "LAUXY", guiX + 20, guiY + 17 , new Color((int) ClickGUI.red.getValue(), (int) ClickGUI.green.getValue(), (int) ClickGUI.blue.getValue()).getRGB());
