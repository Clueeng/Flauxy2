...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 6: {
                this.loginThread = new AltLoginThread(AltManager.lastAlt.getUsername(), AltManager.lastAlt.getPassword());
                this.loginThread.start();
                break;
            }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        if (Mouse.hasWheel()) {
            ...
            if (wheel < 0) {
                ...
                if(this.offset > (Noctura.INSTANCE.altManager.getRegistry().size() * 26) - 52){
                    this.offset -= 26;
                }
            } else if (wheel > 0) {
                this.offset -= 26;
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Noctura.INSTANCE.altManager;
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                ...
                Gui.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2146101995);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                Gui.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2145180893);
            }
