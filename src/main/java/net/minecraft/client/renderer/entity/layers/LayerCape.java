...
public class LayerCape implements LayerRenderer
{
    ...
    {
        if(entitylivingbaseIn.getName().equals(Minecraft.getMinecraft().session.getUsername())) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);

            // apply cape
            int index = Noctura.INSTANCE.getCapeManager().CURRENT_CAPE;
            ArrayList<Cape> capes = Noctura.INSTANCE.getCapeManager().getCapes();
