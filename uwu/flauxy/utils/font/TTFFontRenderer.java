...
public class TTFFontRenderer {
    ...
    public TTFFontRenderer(ExecutorService executorService, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue, Font font) {
        this(executorService, textureQueue, font, 256);
    }

    public TTFFontRenderer(ExecutorService executorService, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue, Font font, int characterCount) {
        this(executorService, textureQueue, font, characterCount, true);
    }

    public TTFFontRenderer(ExecutorService executorService, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue, Font font, boolean antiAlias) {
        this(executorService, textureQueue, font, 256, antiAlias);
    }

    public TTFFontRenderer(ExecutorService executorService, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue, Font font, int characterCount, boolean antiAlias) {
        this.font = font;
     ...
     */
    private CharacterData[] setup(CharacterData[] characterData, int[] texturesIds, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue, int type) {
     ...
     */
    private void createTexture(int textureId, BufferedImage image, ConcurrentLinkedQueue<fr.flailyclient.utils.fonts.TextureData> textureQueue) {
        ...
        textureQueue.add(new fr.flailyclient.utils.fonts.TextureData(textureId, image.getWidth(), image.getHeight(), buffer));
