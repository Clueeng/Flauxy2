...
import uwu.flauxy.event.RenderCallback;
import uwu.flauxy.utils.render.RenderUtil;
import uwu.flauxy.utils.shader.creator.BackgroundShader;
...
public class GlowUtil {
    ...
    private static final BackgroundShader shader = new BackgroundShader(VERTEX_SHADER, OUTLINE_SHADER) {
        @Override
    ...
    public static void onRenderGameOverlay(ScaledResolution scaledResolution, Framebuffer mcFramebuffer) {
        ...
        shader.use();
        RenderUtil.glDrawFramebuffer(framebuffer.framebufferTexture, scaledResolution.getScaledWidth(), scaledResolution.getScaledHeight());
        glUseProgram(0);
