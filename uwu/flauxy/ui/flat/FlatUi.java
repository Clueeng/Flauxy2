...
public class FlatUi extends GuiScreen {
    ...
    public float guiX = 200, guiY = 200;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)  {
        ...
        if (currentModule == null) {
            ...
            Flauxy.INSTANCE.getFontManager().getFont("auxy 15").drawString(renderDone ? "" : mc.thePlayer.getName(), (float) (guiX + 90 - 53.5 - 3.2), guiY + 17 + 258 + 4 , -1);

            Flauxy.INSTANCE.getFontManager().getFont("auxy 15").drawString("#" + tag, (float) (guiX + 90 - 53.5 - 3.2), guiY + 17 + 258 + 12, -1);
        }
        ...
        if (currentModule != null && !currentModule.getSettings().isEmpty()) {
            ...
            float valuey = guiY + 100 + valueRoleNow;

            if (currentModule == null) {
                return;
            }

            for (Setting v : currentModule.settings) {
